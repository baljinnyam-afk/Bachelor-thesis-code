...
Бакалаврын судалгаа — Балжинняамын Orgilsaikhan

---

## Ерөнхийлөл

Энэхүү төсөл нь гүнзгийрүүлсэн сургалт (deep learning) ашиглан бага дэлхийн тойрог зам (LEO) дээрх сансрын хөлгийн чиглэл (ориентацийг) тодорхойлох бүрэн цогц системийг хэрэгжүүлдэг. Судалгааны зорилтот сансрын хөлөг нь **CloudSat** буюу НАСА-гийн дэлхий ажиглалтын хиймэл дагуул юм.

Төсөл нь дараах үе шатуудыг хамардаг:

1. **Хиймэл өгөгдлийн сан үүсгэх** — BlenderProc ашиглан бодит байдлын дүрслэл бүхий фотorealistic зураг үүсгэх.
2. **Загвар сургах** — UrsoNet архитектур (ResNet50V2 нуруу + Гауссын хуваалттай Эйлерийн өнцгийн зөөлөн ангилах), хоёр үе шаттай сургах.
...
- Ролл/Пич/Яо таамаглалуудыг үнэн зөв утгуудтай харьцуулж харуулна
...
Сургалтын тэмдэглэл `Resnet_train_script_v3_ursonet.ipynb` нь **UrsoNet** архитектурыг (Proença & Gao, 2020) хэрэгжүүлдэг — Гауссын хуваалттай Эйлерийн өнцгөөр зөөлөн ангилах арга, **ResNet50V2** нуруу дээр тулгуурласан.
...
- **Үе шат 1 — Толгойн дулаан сургалт** (30 эрин): Нуруу хөлдөөсөн, зөвхөн ангилах толгойг lr=1e-3-аар сургана
- **Үе шат 2 — Бүрэн нарийвчлал** (120 эрин): Нурууг хөлдөөгүй BN-тэйгээр нээлттэй болгоно, lr=1e-5 эрт зогсоолттой
...
Тест олонлог дээрх өнцгийн алдааны тархалт:
...
Энэхүү төсөл нь бакалаврын судалгааны хэсэг юм. Бүх эрх хуулиар хамгаалагдсан.
